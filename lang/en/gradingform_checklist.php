...
$string['adminimportmaxbytes'] = 'Maximum import size in bytes';
$string['adminimportmaxbytes_desc'] = 'Maximum compressed DOCX file size or JSON request size accepted by checklist import. The default is 10 MiB.';
...
$string['importerrorfilesize'] = 'The import exceeds the site limit of {$a} bytes.';
...
$string['settingscompanionlink'] = 'Checklist settings companion';
$string['settingscompanionnotice'] = 'Site-wide Checklist settings are optional. If this Moodle version does not show the Checklist administration page, {$a} exposes the same settings; grading continues to work with safe defaults without it.';
